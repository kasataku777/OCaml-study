...
(* test *)
let test1 = koushin {namae="茗荷谷";saitan_kyori=0.;temae_list=["茗荷谷"]} [] global_ekikan_list
=[]
let test2 = koushin {namae="茗荷谷";saitan_kyori=0.;temae_list=["茗荷谷"]} [{namae="新大塚"; saitan_kyori=infinity;temae_list=[]}] global_ekikan_list
=[{namae="新大塚"; saitan_kyori=1.2;temae_list=["新大塚";"茗荷谷"]}]
let test3 = koushin {namae="茗荷谷";saitan_kyori=0.;temae_list=["茗荷谷"]} 
[{namae="新大塚"; saitan_kyori=infinity;temae_list=[]};{namae="西船橋";saitan_kyori=infinity;temae_list=[]}] global_ekikan_list
